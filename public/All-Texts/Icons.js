...
export const TwitterIcon = ({ className, ...rest }) => (
  ...
  className={`w-full h-auto ${className}`}
>
  <path fill="currentColor" d="M18.7 2H22L14.8 10.3L23.5 22H16.9L11.5 14.9L5.2 22H2L9.7 13.1L1.5 2H8.3L13.3 8.5L18.7 2ZM17.5 20H19.6L7.1 4H4.8L17.5 20Z"/>
</svg>
...
export const InstagramIcon = ({ className, ...rest }) => (
  ...
  <radialGradient id="b"
   cx="70.652" cy="96.49"
    r="113.963" 
    gradientUnits="userSpaceOnUse"><stop offset=".64" 
    stop-color="#8c3aaa" stop-opacity="0"></stop><stop offset="1" 
    stop-color="#8c3aaa"></stop></radialGradient></defs><path 
    fill="url(#a)" 
